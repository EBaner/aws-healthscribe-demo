...
export function InputName({ jobName, setJobName }: InputNameProps) {
    return (
        <FormField
            label="Job name"
            description="The name can be up to 200 characters long. Any spaces used will be replaced with underscores(_). Please follow your practices typical naming conventions"
        >
